  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='店铺位置' prop="shangjiaAddress">
               <el-input v-model="ruleForm.shangjiaAddress"  placeholder='店铺位置' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='区域' prop="quyuTypes">
                 <el-select v-model="ruleForm.quyuTypes"  placeholder='请选择区域'>
                     <el-option
...
// 注册表 商家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.quyuTypes)&& 'shangjia'==this.flag){
                         ...
                         if((!this.ruleForm.jinyongTypes)&& 'shangjia'==this.flag){
