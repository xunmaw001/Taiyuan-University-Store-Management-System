    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">学院商铺管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="店铺位置" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaAddress" autocomplete="off" placeholder="店铺位置"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="区域" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.quyuTypes" autocomplete="off" placeholder="区域"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="账户状态" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.jinyongTypes" autocomplete="off" placeholder="账户状态"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="申请状态" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaYesnoTypes" autocomplete="off" placeholder="申请状态"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="审核意见" class="input" v-if="tableName=='shangjia'">
                                <el-input type="textarea" v-model="ruleForm.shangjiaYesnoText" placeholder="审核意见"></el-input>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="审核时间" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaShenheTime" autocomplete="off" placeholder="审核时间"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //     return
                            // }
                            // shangjia 中的 店铺位置 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaAddress== null ||this.ruleForm.shangjiaAddress== "")){
                            //     this.$message.error("店铺位置不能为空");
                            //     return
                            // }
                            // shangjia 中的 区域 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.quyuTypes== null ||this.ruleForm.quyuTypes== "")){
                            ...
                            //     return
                            // }
                            // shangjia 中的 账户状态 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
                            // shangjia 中的 申请状态 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaYesnoTypes== null ||this.ruleForm.shangjiaYesnoTypes== "")){
                            //     this.$message.error("申请状态不能为空");
                            //     return
                            // }
                            // shangjia 中的 审核意见 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaYesnoText== null ||this.ruleForm.shangjiaYesnoText== "")){
                            //     this.$message.error("审核意见不能为空");
                            //     return
                            // }
                            // shangjia 中的 审核时间 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaShenheTime== null ||this.ruleForm.shangjiaShenheTime== "")){
                            //     this.$message.error("审核时间不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xueyuanshangpuguanlixitong/img/back-img-bg.jpg);
