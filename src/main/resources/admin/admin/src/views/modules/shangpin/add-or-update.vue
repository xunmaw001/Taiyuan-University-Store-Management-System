        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info' && sessionTable!='shangjia'"  label="推荐" prop="tuijianTypes">
                        <el-select v-model="ruleForm.tuijianTypes" :disabled="ro.tuijianTypes" placeholder="请选择推荐">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="推荐" prop="tuijianValue">
