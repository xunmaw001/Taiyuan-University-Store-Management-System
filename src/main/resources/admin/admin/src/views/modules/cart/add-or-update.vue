    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="推荐" prop="tuijianValue">
                        <el-input v-model="shangpinForm.tuijianValue"
                                  placeholder="推荐" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
