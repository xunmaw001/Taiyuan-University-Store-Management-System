    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="店铺位置" prop="shangjiaAddress">
                       <el-input v-model="ruleForm.shangjiaAddress"
                                 placeholder="店铺位置" clearable  :readonly="ro.shangjiaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="店铺位置" prop="shangjiaAddress">
                           <el-input v-model="ruleForm.shangjiaAddress"
                                     placeholder="店铺位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangjiaYesnoTypes" label="申请状态" prop="shangjiaYesnoTypes">
                        <el-input v-model="ruleForm.shangjiaYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaAddress: [
                              { required: true, message: '店铺位置不能为空', trigger: 'blur' },
                          ],
                   quyuTypes: [
