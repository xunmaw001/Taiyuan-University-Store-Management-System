...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R shenhe(@RequestBody ShangjiaEntity shangjiaEntity, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,shangjiaEntity:{}",this.getClass().getName(),shangjiaEntity.toString());

        ShangjiaEntity oldShangjia = shangjiaService.selectById(shangjiaEntity.getId());//查询原先数据

//        if(shangjiaEntity.getShangjiaYesnoTypes() == 2){//通过
//            shangjiaEntity.setShangjiaTypes();
//        }else if(shangjiaEntity.getShangjiaYesnoTypes() == 3){//拒绝
//            shangjiaEntity.setShangjiaTypes();
//        }
        shangjiaEntity.setShangjiaShenheTime(new Date());//审核时间
        shangjiaService.updateById(shangjiaEntity);//审核
...
//                            shangjiaEntity.setShangjiaAddress(data.get(0));                    //店铺位置 要改的
//                            shangjiaEntity.setQuyuTypes(Integer.valueOf(data.get(0)));   //区域 要改的
...
//                            shangjiaEntity.setJinyongTypes(Integer.valueOf(data.get(0)));   //账户状态 要改的
//                            shangjiaEntity.setShangjiaYesnoTypes(Integer.valueOf(data.get(0)));   //申请状态 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(shangjia.getJinyongTypes() != 1)
            return R.error("账户已被禁用");
        else if(shangjia.getShangjiaYesnoTypes()==1)
            return R.error("请耐心等待审核");
        else if(shangjia.getShangjiaYesnoTypes()==3)
            return R.error("审核被拒绝,理由是:"+shangjia.getShangjiaYesnoText());
